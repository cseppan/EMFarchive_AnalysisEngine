...
/**
* A class which describes an option that can be set by the user. Options are
* applicable to both pages and plots. This class will store the name, class
* type of value, tooltip text and the editor class for value. Note that a
...
gov.epa.mims.analysisengine.tree.AnalysisOptionConstantsIfc
{
   ...
   static
   {
      ...
      addNewOptionInfo(PLOT_TITLE,
         "Plot Title", Text.class, null, TextEditor.class);

      addNewOptionInfo(PLOT_SUBTITLE,
         "Plot Subtitle", Text.class, null, TextEditor.class);

      addNewOptionInfo(PLOT_FOOTER,
         "Plot Footer", Text.class, null, TextEditor.class);

      addNewOptionInfo(WORLD_COORDINATES,
         "World Coordinates", WorldCoordinates.class, null,
         WorldCoordinatesEditor.class);

      addNewOptionInfo(LEGEND,
         "Legend", Legend.class, null, LegendEditor.class);

      addNewOptionInfo(X_NUMERIC_AXIS,
         "X Axis", AxisNumeric.class, null, AxisNumericEditor.class);

      addNewOptionInfo(Y_NUMERIC_AXIS,
         "Y Axis", AxisNumeric.class, null, AxisNumericEditor.class);

      addNewOptionInfo(NUMERIC_AXIS,
         "Numeric Axis", AxisNumeric.class, null, AxisNumericEditor.class);

      addNewOptionInfo(CATEGORY_AXIS,
         "Category Axis", AxisCategory.class, null, AxisCategoryEditor.class);

      addNewOptionInfo(X_TIME_AXIS,
         "X Axis", AxisTime.class, null, AxisTimeEditor.class);

      addNewOptionInfo(LINE_TYPE,
         "Line Type", LineType.class, null, LineTypeEditor.class);

      addNewOptionInfo(OUTLINE_TYPE,
         "Borders", OutlineType.class, null, OutlineTypeEditor.class);

      addNewOptionInfo(GRID_TYPE,
         "Grid Type", GridType.class, null, GridTypeEditor.class);

      addNewOptionInfo(BAR_TYPE,
         "Bars", BarType.class, null, BarTypeEditor.class);

// the following 2 line will not compile
      addNewOptionInfo(BOX_TYPE,
         "Box & Whiskers", BoxType.class, null, BoxTypeEditor.class);

      addNewOptionInfo(HISTOGRAM_TYPE,
         "Histogram", HistogramType.class, null, HistogramTypeEditor.class);

      addNewOptionInfo(PAGE_TYPE,
         "Page Options", PageType.class, null, PageTypeEditor.class);

      addNewOptionInfo(SORT_TYPE,
         "Sorting", SortType.class, null, SortTypeEditor.class);

      addNewOptionInfo(DISPLAY_SIZE_TYPE,
         "Margin Size", DisplaySizeType.class, null, DisplaySizeEditor.class);

      addNewOptionInfo(TEXT_BOXES,
         "Text Boxes", TextBoxesType.class, null, TextBoxesTypeEditor.class);

      addNewOptionInfo(TORNADO_TYPE,
         "TornadoType", TornadoType.class, null, TornadoTypeEditor.class);
      
      addNewOptionInfo(LINEAR_REGRESSIONS,
         "Linear Regressions", LinearRegressionType.class, null, LinearRegressionTypeEditor.class);
   ...
   private static void setGlobalDefaultOptions()
   {
      ...
      AvailableOptionsAndDefaults.addGlobalDefaultValue(
          TORNADO_TYPE, defaultTornadoType);
      ...
      AvailableOptionsAndDefaults.addGlobalDefaultValue(
         OUTLINE_TYPE, defaultOutlineType);
      ...
      AvailableOptionsAndDefaults.addGlobalDefaultValue(
         X_NUMERIC_AXIS, defaultXNumericAxis);
      ...
      AvailableOptionsAndDefaults.addGlobalDefaultValue(
         Y_NUMERIC_AXIS, defaultYNumericAxis);
      ...
      AvailableOptionsAndDefaults.addGlobalDefaultValue(
         NUMERIC_AXIS, defaultNumericAxis);
      ...
      AvailableOptionsAndDefaults.addGlobalDefaultValue(
         CATEGORY_AXIS, defaultCategoryAxis);
...
//   }//
   ...
   private static void addNewOptionInfo(String keyword,
      String name, Class valueType, String toolTipText,
      Class valueEditorType)
   {
     OptionInfo optionInfo = new OptionInfo(keyword, name, valueType, toolTipText,
                                            valueEditorType);
   ...
   */
   public OptionInfo(String keyword, String name, Class valueType,
      String toolTipText,
      Class valueEditorType)
   {
   ...
   /**
   * @param keyword String keyword to lookup
   ...
   *
   * @param keyword String that is the keyword to add
   * @param optionInfo OptionInfo to add as the value in the map
   * @return null if the keyword wasn't in the map, or the old value if it's
   * already in there
   */
   ...
   /**
   * @return Object a default editor (i.e. dialog) for values with a particular
   * class.
   */
    ...
    * @throws Exception if there is a problem cloning or getting a new instance
    */
   public AnalysisOption getDefaultValue() throws Exception
   {
     AnalysisOption defaultObject =
        (AnalysisOption)AvailableOptionsAndDefaults.getGlobalDefaultValue(keyword);
