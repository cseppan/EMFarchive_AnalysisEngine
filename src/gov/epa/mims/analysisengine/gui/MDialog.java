 ...
 *
 * The escape key handling is adapted from
 * <a href="http://www.javaworld.com/javaworld/javatips/jw-javatip72.html">
 * JavaWorld Tips</a>.  This doesn't seem to work with dialogs that
 * have text fields (at least NewMemberDialog).
 *
 * @author Steve Fine
 * @version $Id: MDialog.java,v 1.1 2005/09/19 14:14:04 rhavaldar Exp $
 *
 **/
 ...
 *****************************************************/
  ...
  /**
   * create a custom root pane that will recognize when the escape key
   * was pressed and destroy the dialog
   **/
