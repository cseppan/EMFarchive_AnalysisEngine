 ...
 * @version $Id: LineTypeEditor.java,v 1.1 2005/09/19 14:14:04 rhavaldar Exp $
 *
 **/

public class LineTypeEditor
extends OptionDialog
{
    ...
    * @param aLineType the linetype to be edited
    */
    ...
    * @param dataSource source of the data of type tree.LineType
   ...
   private void initialize()
   {
      ...
      {symbolsColumn,sizeColumn,lineStyleColumn,widthColumn,colorColumn};
   ...
   protected void initGUIFromModel()
   {
      ...
      if(this.lineType != null)
      {
         ...
         tablePanel.setValueAt(symbolsStyleConverter.getPrettyOptions(
            lineType.getSymbol()),SYMBOL_COLUMN_NUMBER);
         ...
         tablePanel.setValueAt(lineStyleConverter.getPrettyOptions(
            lineType.getLineStyle()),LINESTYLE_COLUMN_NUMBER);
      ...
      {
         DefaultUserInteractor.get().notify(this,"Null Pointer Exception",
         "The lines have not yet been created.",
         UserInteractor.NOTE);
      }

   }//initGUIFromModel()

   /** The LineType does not have equal length arrays for symbols, linestyles, colors
    * linewidth and symbol expansion.
    * So this method is only called when this gui is initialized first time.
    * and this will create equal arrays and set the values in the LineType.
    * WARNING: This method based on on the default values in the LineType class.
    * @see LineType
    */
   ...
   protected void saveGUIValuesToModel() throws Exception
   {
      if(tablePanel.getRowCount()==0)
      {
         ...
         "You should have at least one line in the table. Please insert a line.",
