 ...
 * @version $Id: ColorEditableTablePanel.java,v 1.2 2005/09/19 14:50:03 rhavaldar Exp $
 */
public class ColorEditableTablePanel extends EditableTablePanel
{
    ...
    *
    * @author Daniel Gatti
    * @param value Object that must be a Color and is the default value to place in a new row.
    */
   public void setDefaultValue(Object value)
   {
      if (defaultValue instanceof Color)
         defaultValue = (Color)value;
           ...
           DefaultUserInteractor.get().notify(this,"Unexpected object type",
           "Expected a Color value in ColorEditableTablePanel.setDefaultValue()",
   ...
   /**
    * Create a JPanel that will have a background color that is the value in the cell.
    * Set this as the default renderer for column 1.
    *
    * @author Daniel Gatti
    */
   ...
   /**
    * An editor that will bring up a JColorChooser on a double-click and allow
    * the user to select a color for the selected cell.
    *
    * @author Daniel Gatti
   ...
   class ColorCellEditor extends DefaultCellEditor
   {
      ...
      /**
       * Return either the colo that the user chose if editing was successful or
       * the original color if editing was cancelled.
       *
       ...
       *
       * @return JLabel that says "Editing..." to fill the cell while the JColorChooser
       * is displayed.
       */
      ...
      {
         returnColor =
            JColorChooser.showDialog(ColorEditableTablePanel.this, "Choose Color", originalColor);
         if (returnColor == null)
            returnColor = originalColor;
