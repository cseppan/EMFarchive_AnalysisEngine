...
/**
 * A utility panel for editing colors includes options to have a label,
...
public class ColorValuePanel extends JPanel
{
    ...
    * @param val the COlor to set the panel to
    */
    ...
    * @param enable to enable the colorpanel or not
    */
