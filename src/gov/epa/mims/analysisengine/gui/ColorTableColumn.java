...
{
   /** The list of valid choices for the user to choose from. This will be
    * null if the user can enter any value. */
      ...
      comboBox.setRenderer(new ListCellRenderer()
         {
               ...
               Object value, int index, boolean isSelected, boolean cellHasFocus)
            {
               ...
               if (obj != null)
               {
                  ...
                  {
                     DefaultUserInteractor.get().notify(list,"Unexpected object type",
                        "Expected a Color value in ColorEditableTablePanel."
                        + "getListCellRendererComponent().Found a "
   ...
   class ColorCellEditor extends DefaultCellEditor
   {
      ...
      public boolean shouldSelectCell(EventObject e)
      {
         ...
         returnColor =
            JColorChooser.showDialog(table, "Choose Color", originalColor);
