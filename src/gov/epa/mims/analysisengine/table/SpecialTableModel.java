...
public class SpecialTableModel extends MultiRowHeaderTableModel
{
  ...
  */
   ...
   */
    ...
    */
    public SpecialTableModel(String[] columnRowHeaders, String[][] columnHeaders,
      ArrayList tableData, Class[] columnTypes)
    {
       super(columnRowHeaders, columnHeaders);
       this.tableData = tableData;
    ...
    * Constructor.
    */
    public SpecialTableModel(String tableDataHeader, String[] columnRowHeaders,
       String[][] columnHeaders, ArrayList tableData, String tableDataFooter, Class[] columnTypes)
    {
       super(columnRowHeaders,columnHeaders);
