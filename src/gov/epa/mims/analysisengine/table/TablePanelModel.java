...
/**
 * <p>Title:TablePanelModel.java </p>
 * <p>Description: A data model to hold the data in a table panel</p>
 * <p>Copyright: Copyright (c) 2004</p>
 * <p>Company: CEP, UNC-Chapel Hill </p>
 * @author Parthee Partheepan
 * @version $Id: TablePanelModel.java,v 1.2 2005/09/19 14:50:03 rhavaldar Exp $
 */
public class TablePanelModel
{
   ...
   /** store the row header for the column */
...
//   private int tabNo = -1;
   ...
   public TablePanelModel(String tableDataHeader, String[] columnRowHeaders,
      String[][] columnHeaders, ArrayList tableData, String tableDataFooter,
      Class[]  columnTypes)
   {
    ...
    * @param tableDataHeader New value of property tableDataHeader.
    *
    */
    ...
    * @param columnHeaders New value of property columnHeaders.
    *
    */
    ...
    * @param tableDataFooter New value of property tableDataFooter.
    *
    */
