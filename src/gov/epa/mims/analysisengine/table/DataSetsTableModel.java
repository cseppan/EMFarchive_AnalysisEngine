...
/**
 * <p>Title:DataSetsTableModel </p>
 * <p>Description: A table model with DataSestAdapter as a data model</p>
...
public class DataSetsTableModel extends SpecialTableModel
{
   ...
   public Object getValueAt(int rowIndex, int columnIndex)
   {
      ...
      {
         DefaultUserInteractor.get().notify(null,"Error",
           columnIndex + " > maximum column in the table model:"+length ,
            UserInteractor.ERROR);
         return "";
      }
   ...
   private void calculateRowCount()
   {
      ...
      {
         DefaultUserInteractor.get().notify(null,"Error",
               "A error in DataSetsTableModel.calculateRowCount()"+ e.getMessage(),
               UserInteractor.ERROR);
      }
