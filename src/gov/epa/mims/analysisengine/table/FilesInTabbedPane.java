...
/**
 * FilesInTabbedPane.java
 * Store the file names which are shown on the tab panes and remove or add when
 * tabs closes and opened. Also this class will be used to get a unique name for
 * a filename to be shown in the tab
...
public class FilesInTabbedPane
{
   ...
   /** to add a file name
    * @param aFileName(absolutePath) a name of file to be added to the tab
    * @param aTabName user specified tab Name
    * @pre aFileName != null
    * @pre aTabName != null
    */
   public void addFileName(String aFileName, String aTabName) throws Exception
   {
      ...
      tabNumber ++ ;
//System.out.println("uniqueTabNames.size()="+uniqueTabNames.size());
//System.out.println("tabNames.size()="+tabNames.size());
//System.out.println("fileNames.size()="+fileNames.size());
//System.out.println("tabNumber="+tabNumber);
   }

   /* a helper method to create a unique tab name
    * @param aTabName a file name
    * @pre aFileName absolutePath
    */
