 ...
 *
 * @author Alison Eyth
 * @version $Id: EditingDialog.java,v 1.2 2005/09/19 14:50:03 rhavaldar Exp $
 */
public abstract class EditingDialog extends JDialog
{
   ...
   /**
    * Call this when an object on the dialog has changed.  It changes the title,
    * enables the "OK" button, and changes the name of the "Close" button to
    * "Cancel".
    */
   ...
   protected void jbInit() throws Exception
   {
      ...
      if (helpAvailable) buttonPanel.add(helpButton, null);
