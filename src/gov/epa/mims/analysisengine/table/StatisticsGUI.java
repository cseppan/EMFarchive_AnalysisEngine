 ...
 * @version $Id: StatisticsGUI.java,v 1.1 2005/09/19 14:14:04 rhavaldar Exp $
 */
 ...
 public class StatisticsGUI extends JDialog
{
   ...
   /** variable to denote whether user hits OK or CANCEL
...
//   }
   ...
   private void initialize()
   {
      ...
      JPanel insPanel = createInsPanel();
      ...
      firstPanel.setBorder(BorderFactory.createCompoundBorder(
         outsideBorder,BorderFactory.createCompoundBorder(insideBorder,outsideBorder)));
      ...
      correlationPanel.setLayout(new BoxLayout(correlationPanel,
BoxLayout.Y_AXIS));
...
//          RegressionModel(statisticsModel.getOverallTableModel());
     ...
     // correlationPanel.add(correlationGUI);
      ...
      tabbedPane.insertTab("Correlation", null, correlationPanel,
null,CORRELATION_TAB);
   ...
   private JPanel createBasicStatsPanel()
   {
      ...
      statsPanel.setBorder(BorderFactory.createTitledBorder(
         BorderFactory.createLineBorder(Color.black),"Basic Statistics"));
   ...
   private JPanel createDataPanel()
   {
      ...
      dataPanel.setBorder(BorderFactory.createTitledBorder(
         BorderFactory.createLineBorder(Color.black),"Columns To Analyze"));
   ...
   private void showColumnSelectionGUI()
   {
      ...
      filterGUI = new SelectColumnsGUI((JFrame)parent, filterCriteria, "Include/Exclude Columns",
         "Include", "Exclude");
      ...
      for(int i=0; i< showColumns.length; i++)
      {
         ...
         {
            DefaultUserInteractor.get().notify(this,"Error", "The class type of selected columns " +
               "should be either an Integer or a Double."+
               "\nThe column "+ names[i] + " is type "+ columnClasses[i],
      ...
      if(!atLeastOneColumnSelected)
      {
         DefaultUserInteractor.get().notify(this,"Warning", "You should select atleast "+
            "one integer or double column.", UserInteractor.WARNING);
         dataSets = null;
         histogramGUI = null;
   ...
   private void createDataSets()
   {
      ...
      {
         DefaultUserInteractor.get().notify(this,"Error",ex.getMessage(),
            UserInteractor.ERROR);
      }//catch
   }//createDataSets
   ...
   private JPanel createAnalysisPanel()
   {
      ...
      analysisPanel.setBorder(BorderFactory.createTitledBorder(
         BorderFactory.createLineBorder(Color.black),"Analyses to Perform"));
...
//      analysisPanel.add(Box.createHorizontalGlue());
   ...
   private void createCorrelationGUI()
   {
      ...
      {
         statisticsModel.setRegressionModel(new
RegressionModel(statisticsModel.getOverallTableModel()));
      ...
      correlationGUI = new RegressionGUI(statisticsModel.getRegressionModel(),
true);
      JPanel correlationPanel =
(JPanel)tabbedPane.getComponentAt(CORRELATION_TAB);
   ...
   private void createRegressionGUI()
   {
      ...
      regressionGUI = new RegressionGUI(statisticsModel.getRegressionModel(),
false);
      JPanel regressionPanel =
(JPanel)tabbedPane.getComponentAt(REGRESSION_TAB);
   ...
   private JPanel createInsPanel()
   {
      ...
      String step1 = "Step1: Select the data you want to choose by clicking "+
         "the \"Select\" button. Please note that the data selected should be " +
      ...
      JScrollPane scrollPane = new JScrollPane(insTextArea,
...
//      scrollPane.setSize(10, 10);
   ...
   private void saveToModel()
   {
      ...
      {
         DefaultUserInteractor.get().notify(this,"Error","No data is "+
            " selected for the analysis. Please select the data or click " +
            " Cancel button.",
            UserInteractor.ERROR);
         closeDialog = false;
         return;
      ...
      {
         DefaultUserInteractor.get().notify(this,"Error", "Please enter a tab name "
            + "for the basic statstics analysis", UserInteractor.ERROR);
         closeDialog = false;
         return;
      }
   ...
   /** return JOptionPane.OK_OPTION or JOptionPane.CANCEL_OPTION depends on
   * whether user clicks on OK or CANCEL Button
   */
   ...
   public static void main(String[] args)
   {
      ...
      StatisticsGUI statisticsGUI = new StatisticsGUI(frame,model, "Test"); // just see the layout
