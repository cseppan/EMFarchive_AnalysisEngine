...
/**
 * This class extends the decimal format and attempts add the significant digits
 * feature
 *
...
public class SignificantDigitsFormat extends DecimalFormat
{
   ...
   {STANDARD_FORMAT,
    SCIENTIFIC_FORMAT, CURRENCY_FORMAT, PERCENTAGE_FORMAT, CUSTOM_FORMAT};
...
//       setNumberOfDecimalPlaces(1);
    ...
    FieldPosition fieldPosition)
    {
       ...
       return super.format(Double.parseDouble(formattedNumber), result,
       fieldPosition);
    ...
    //it's a runtime exception
    {
       if (numSigDigits < 0)
       {
          throw new IllegalArgumentException("The number of significant digits "
          + "cannot be negative");
       }
     ...
     * @throws IllegalArgumentException
     */
    public void setNumberOfDecimalPlaces(int numDecimalPlaces)
    throws IllegalArgumentException
    {
       if (numDecimalPlaces < 0)
       {
          throw new IllegalArgumentException("The number of decimal places "
          + "cannot be negative");
       }
    ...
    /**
     * resolves the paramters set into this formatter into a string equivalent
     * REMEMBER that the significant digits will not be part of this string
     * It is applied in a different fashion
