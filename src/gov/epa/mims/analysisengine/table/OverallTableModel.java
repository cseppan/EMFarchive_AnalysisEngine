...
/**
 * <p>Description: A model that controls the underlying sort, filter and
 * aggregating models.</p>
...
java.io.Serializable, FormatAndIndexInfoIfc
{
   ...
   * Don't need to implement this method
    ...
    * @param redo boolean that is true if we should redo the aggregation.
    */
...
//System.out.println("OverallModel:getColumnCount() " + headerModel.getColumnCount());
   ...
   * Return the column headers.
    * @param col int that is the column.
    ...
    *@param col0 String first value of a column header for a column
    *@return int return the column index corresponds to the column name, if corresponding 
...
//System.out.println("header model.getColumnName="+headerModel.getColumnName(i));            
    ...
    * @param col int that is the column.
    * @param colOrder int[] that is the column order
    * @param separator String that is the column order
   ...
   /**
    * Return the headers in the top left corner of the table. We are calling
    * the headers above the column headers "column headers" and the headers
    * next to the rows "row headers", so we're calling these "column row headers".
    * @return String[] that is the headers above the requested column.
    */
  ...
  /**
    * Return the headers in the top left corner of the table except the 'units' 
    * row header. 
    * We are calling the headers above the column headers "column headers" and 
    * the headers next to the rows "row headers", so we're calling these 
    * "column row headers".
    * @return String[] that is the headers above the requested column.
    */
   ...
   /** return the index of the rowHeader which maches the argument 'name'; not
   * case sensitive; return -1 if the 'name' is not in the column row header
   * @param name 
  ...
  public int getColumnRowHeaderIndex(String name)
  {
   ...
   /**
    * Return the data value at the requested index. This does *NOT* include
    * the header row and is designed for users getting data from the table.
    * @param rowIndex int that is the row.
    * @param columnIndex int that is the column.
...
//System.out.println("overallModel.getValueAt("+rowIndex+", "+columnIndex+")");
   ...
   /**
    * Only reset the part of the model specified. This is used to reset the
    * filter model for the "show top N rows" command.
    * @param resetRows boolean that is true if the row filtering should be reset.
    * @param resetColumns boolean that is true if the row filtering should be reset.
  ...
  /**
    ...
    * @param sortCriteria SortCriteria to use when sorting the data.
    */
   ...
   * @return boolean[]  The array will contain true value if the column is type of
   * double
   * @pre getColumnCount> 1
   * WARNING: precondition is not checked
   */
   ...
   * @return  The array will contain the true for the first col which is of type
   * string or integer
   * @pre getColumnCount> 1
   * WARNING: precondition is not checked
   */
