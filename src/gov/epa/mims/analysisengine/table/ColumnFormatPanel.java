...
/**
 * <p>Description: A GUI to allow the user to edit the column format with
 * item such as font, alignment and number format.</p>
 * <p>Copyright: Copyright (c) 2003</p>
 * <p>Company: UNC - CEP</p>
 * @author Daniel Gatti
 * @version $Id: ColumnFormatPanel.java,v 1.2 2005/09/19 14:50:03 rhavaldar Exp $
 */
public class ColumnFormatPanel extends JPanel
{
    ...
    * Constructor
    *
    * @param columnFormatInfo ColumnFormatInfo with the formatting information
    *    about the column.
    */
    ...
    * @throws Exception that gets passed up from saveGUIValuesToModel().
    */
   ...
   /**
    * Set a new text formatter to be displayed. Also change the GUI to reflect
    * the new format.
    *
    * @param newFormat Format to use in the panel. Pass in null to show no text
    ...
    public void setFormat(Format newFormat)
    {
       ...
       if (formatInfo.getFormat() != null)
       {
          ...
          if (formatInfo.getFormat() instanceof SimpleDateFormat)
          {
             ...
             formatPanel = new DateFormatPanel(
                   (SimpleDateFormat)formatInfo.getFormat(),
                   DateFormatPanel.EXAMPLE_DATE_FORMATS,
                   DateFormatPanel.EXAMPLE_TIME_FORMATS, true);
          }
          else if (formatInfo.getFormat() instanceof SignificantDigitsFormat)
          {
             formatPanel = new DoubleFormatPanel(
