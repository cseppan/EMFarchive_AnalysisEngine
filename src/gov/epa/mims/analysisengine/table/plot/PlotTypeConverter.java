 ...
 * <p>Description: A class to map between the nice name for plots and the constants
 * available in the AnalysisEngineConstants
...
public class PlotTypeConverter
{
   ...
   public static final String [] AVAILABLE_PLOT_TYPES = 
      {
         BAR_PLOT, 
         BOX_PLOT,
         CDF_PLOT,
  ...
  /** mapping from constants in the table package to AnalysisEngineConstants in 
   * the tree package
   * key= table plot type constants
   */
