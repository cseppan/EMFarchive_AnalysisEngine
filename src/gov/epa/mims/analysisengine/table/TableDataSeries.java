...
/**
 * This class implements the LabeledDataSetIfc and extends the AbstractDataSet
 * class from the tree engine. When the plot button is clicked in the table panel
 * a DataSets object will be created containing a number of these TableDataSeries
 *
 * @author Prashant Pai, CEP UNC
 * @version $Id: TableDataSeries.java,v 1.1 2005/09/19 14:14:04 rhavaldar Exp $
 */

public class TableDataSeries
    extends AbstractDataSet implements LabeledDataSetIfc
{
  /** serial version UID */
   ...
   */
  public TableDataSeries(OverallTableModel model, int valueCol, 
   int [] labelColumns, char separator)
  {
...
//  {
//    if (plottingInfo.getUnits() != null)
//    {
//      return plottingInfo.getUnits();
//    }
//    return "";
//  }//getUnits()
   ...
   * @throws Exception if there is Exception while printing
   **********************************************************/
