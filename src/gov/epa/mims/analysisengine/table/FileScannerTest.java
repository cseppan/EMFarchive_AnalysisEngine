...
{
   /**
    * Constructor for FileScannerTest.
    * @param arg0
    */
   String EXAMPLE_FILES_LOCATION = null;

   public FileScannerTest(String arg0)
   {
      super(arg0);
      EXAMPLE_FILES_LOCATION = System.getProperty("EXAMPLE_FILES_LOCATION");
      if(EXAMPLE_FILES_LOCATION == null) {
         System.out.println("EXAMPLE_FILES_LOCATION not set");
         System.exit(1);
      }
   }
   ...
   {
      String filename = new String(EXAMPLE_FILES_LOCATION+File.separator+"NormalFile");
      String[] lines = null;
      try {
      ...
      try {
      scanner=new FileScanner(new java.io.FileReader(EXAMPLE_FILES_LOCATION+File.separator+"NormalFile"));
...
/*
       ...
       if(lines[i++].compareTo(line.substring(0, line.length()-1))==0)
          equality = true;
...
*/      }
      ...
      line=scanner.getLine();
      assertEquals(line, "");
      } catch(IOException ie) { assertEquals(true, false); }
   }
   ...
   public void testWithNewLineCharacterOnlyLine() {
      String line="\n"; 
      FileScanner scanner = null;
      try {
      ...
      try {
      Symbol[] tokens = scanner.getTokensPerLine(',', false);
      if(tokens==null) assertEquals(true, false);
...
scanner.symbol(TokenConstants.STRING_LITERAL, line.substring(0, line.length()-1))};
      try {
   ...
   public void testWithMixedCharacterData() {
      String line = "abcd;234.5;1234;09/12/2004 02:30;qwert;\n";
                FileScanner scanner = null;
                try {
                     scanner=new FileScanner(new StringBufferInputStream(line));
      ...
      } catch(Exception ie) { assertEquals(true, false); }
   }
   ...
   public void testWithDoubleData() {
      String line = "1493.676563463864,6.56150776093055E-8,10.669118310456177,0.0608139743696002,NaN,2.2232386397631296E-4,-1.1584864434794742E8,\"1.9330E-01\"\n";
                ...
                Symbol[] expected_value = { 
                   scanner.symbol(TokenConstants.DOUBLE_LITERAL, new Double("1493.676563463864")),
   ...
   public void testWithIntegerData() {
      String line = "0000:123:023456:-1223\n";
                ...
                Symbol[] expected_value = {
                                            scanner.symbol(TokenConstants.INTEGER_LITERAL, new Integer("0000")),
   ...
   public void testWithDateFormats() {
             //correct date:correct time:wrong time:correct date:wrong date:wrong format: wrong format: without quotes(correct date)
   ...
   public void testWithMissingValues() {
      ...
      FileScanner scanner = null;
                ...
                Symbol[] expected_value = {
                                        ...
                                        scanner.symbol(TokenConstants.NULL_LITERAL, ""),
                                        scanner.symbol(TokenConstants.NULL_LITERAL, ""),
                                        scanner.symbol(TokenConstants.STRING_LITERAL, "abcd"),
                                        scanner.symbol(TokenConstants.NULL_LITERAL, ""),
                                        scanner.symbol(TokenConstants.DOUBLE_LITERAL, new Double("NaN")),
                                        scanner.symbol(TokenConstants.NULL_LITERAL, ""),
                                        scanner.symbol(TokenConstants.NULL_LITERAL,
"")};
   ...
   public void testWithMixedDataInQuotes() {
      ...
      Date date1 = sdf.parse("04/04/1920");
                Symbol[] expected_value = {
                                        scanner.symbol(TokenConstants.STRING_LITERAL, "Stone,Clay,Etc."),
               ...
               scanner.symbol(TokenConstants.NULL_LITERAL, null)};
                assertEquals(compareSymbols(expected_value, scanner.getTokensPerLine(',', false)), true);
                assertEquals(line,scanner.getLine());
                } catch(Exception e) { assertEquals(true, false); }
   }

/*   public void testWithTabInData()
   {
      String line = "\"C:\temp\tata\nem\\\":abcd:NaN:123.4\n";
      FileScanner scanner = null;
                try {
                      scanner=new FileScanner(new
StringBufferInputStream(line));
                } catch(Exception e) {
...
"C:\temp\tata\nem\\"),
                                        scanner.symbol(TokenConstants.STRING_LITERAL,
"abcd"),
                                        scanner.symbol(TokenConstants.DOUBLE_LITERAL,
new Double("NaN")),
                                        scanner.symbol(TokenConstants.DOUBLE_LITERAL,
"123.4") };
      try {
            assertEquals(compareSymbols(expected_value,
            scanner.getTokensPerLine(':')), true);
   //         assertEquals(line,scanner.getLine());
      } catch(IOException ie) { assertEquals(true, false); }
   }
*/
