...
/**
 * <p>Description: A GUI that allows the user to select a set of columns and
 *    show or hide them. </p>
 * <p>Copyright: Copyright (c) 2003</p>
 * <p>Company: </p>
 * @author Daniel Gatti
 * @version $Id: SelectColumnsGUI.java,v 1.1 2005/09/19 14:14:04 rhavaldar Exp $
 */
public class SelectColumnsGUI extends OptionDialog
{
    ...
    * Constructor.
    *
    * @param filterCriteria FilterCriteria to use to set up the GUI.
    * @param title String that is the title to place on the window.
    * @param checkString String to place on the "check" button.
    * @param uncheckString String to place on the "uncheck" button.
    */
   public SelectColumnsGUI(JFrame parent, FilterCriteria filterCriteria, String title,
                           String checkString, String uncheckString)
   {
      super(parent);
   ...
   /**
    * Return the list of all column names. This will have the same length
    * as the boolean array returned by getSelectedColumns().
    *
   ...
   /**
    * Return the list of all column names. This will have the same length
    * as the String array returned by getAllColumnNames().
    *
    ...
    * Build the GUI
    *
    * @param checkString String that is the text to place on the check button.
    * @param uncheckString String that is the text to place on unthe check button.
    */
   protected void initialize(String checkString, String uncheckString)
   {
      ...
      selectionPanel = new ColumnSelectionPanel(transpose,
            filterCriteria.getColumntoShow(), checkString, uncheckString);
   ...
   {
      filterCriteria.setColumnsToShow(
            filterCriteria.getAllColumnNames(),
            selectionPanel.getCheckedColumns());
