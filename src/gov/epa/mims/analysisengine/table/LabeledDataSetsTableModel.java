...
/**
 * <p>Title:LabeledDataSetsTableModel </p>
 * <p>Description: A table model with DataSestAdapter which contain labeled data sets
 * as a data model</p>
 * WARNING: Labels for all the data sets should be same
 * <p>Copyright: Copyright (c) 2003</p>
 * <p>Company: CEP, UNC-Chapel Hill </p>
 * @author Parthee Partheepan
 * @version $Id: LabeledDataSetsTableModel.java,v 1.1 2005/09/19 14:14:04 rhavaldar Exp $
 */
...
System.out.println("column name = "+ getColumnName(col));
    ...
    * @param colName String for the first columnName
    */
   ...
   public static void main(String[] args)
   {
      ...
      int count =ds.length;
      String[] rowLabels = {"label1","label2","label3","label4","label5","label6","label7","label8","label9","label10"};
