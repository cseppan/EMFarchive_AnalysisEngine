...
/**
 * <p>Description: A struct that holds all of the formatting information
 * for a TableColumn. All fields are public. </p>
 * <p>Copyright: Copyright (c) 2003</p>
 * <p>Company: UNC - CEP</p>
 * @author Daniel Gatti
 * @version $Id: ColumnFormatInfo.java,v 1.2 2005/09/19 14:50:03 rhavaldar Exp $
 */
public class ColumnFormatInfo implements java.io.Serializable
{
   ...
   /** The horizontal alignment for the column. Must be one of JLabel.LEFT,
    ...
    * Constructor.
    */
   public ColumnFormatInfo(Font font, int alignment, int width, Format format,
    ...
    *
    * @param column TableColumn to use to populate this object.
    */
