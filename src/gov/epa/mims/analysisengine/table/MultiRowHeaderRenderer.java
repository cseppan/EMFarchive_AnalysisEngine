 ...
 * @version $Id: MultiRowHeaderRenderer.java,v 1.1 2005/09/19 14:14:04 rhavaldar Exp $
...

{
    ...
    *@param values String[] that is the list of values to display in the header.
