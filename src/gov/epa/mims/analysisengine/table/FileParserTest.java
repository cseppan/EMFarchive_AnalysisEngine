...
public class FileParserTest extends TestCase
{
	...
	/**
	 * Constructor for FileParserTest.
	 * @param arg0
	 */
	...
	{
		files_location=System.getProperty("EXAMPLE_FILES_LOCATION");
		if(files_location ==null)
			throw new Exception("EXAMPLE_FILES_LOCATION not set");
		files_location+=File.separator;
	}
	
	static String files_location = null;
	...
	public void testSMOKEFile () {
		...
		try {
			parser = new FileParser(files_location+filenam[0], delimiter,
numColHdrRows, false);
	...
	public void testMonteCarloInput() {
		...
		LoggerIsEmpty = true;
		columnCount = 7;
		Class[] columnTypes = { Integer.class, 
				Double.class, 
				Double.class,
				Double.class, 
				Double.class, 
	...
	public void testCOSU() {
		...
		try {
			parser = new FileParser(files_location+filenam[5], delimiter,
numColHdrRows, false);
			checkMethods(parser,columnTypes);
		} catch(Exception e) {
	...
	public void testTwoDataLinesOnly() {
		FileParser parser = null;
		String delimiter = ";";
		int numColHdrRows = 0;
		FileHeaderIsNull = true;
		...
		Class[] columnTypes = { Date.class, 
				...
				Double.class };
		try {
			parser = new FileParser(files_location+filenam[7], delimiter,
numColHdrRows, false);
			checkMethods(parser,columnTypes);
		} catch(Exception e) {
	...
	public void testDataOnly() {
		...
		try {
			parser = new FileParser(files_location+filenam[19], delimiter,
numColHdrRows, false);
			checkMethods(parser,columnTypes);
		} catch(Exception e) {
	...
	public void testOneHeaderLineOneDataLine() {
		FileParser parser = null;
		String delimiter = ":";
		int numColHdrRows = 1;
		FileHeaderIsNull = false;
		...
		try {
			parser = new FileParser(files_location+filenam[8], delimiter,
numColHdrRows, false);
			checkMethods(parser,columnTypes);
		} catch(Exception e) {
	...
	public void testDataWithMissingValues() {
		...
		try {
			...
			parser = new FileParser(files_location+filenam[9], delimiter,
numColHdrRows, false);
			checkMethods(parser,columnTypes);
	...
	public void testIntegerMixedWithDouble() {
		FileParser parser = null;
		String delimiter = ",";
		int numColHdrRows = 1 ;
		FileHeaderIsNull = false;
		...
		LoggerIsEmpty = true;
		columnCount = 6;
		Class[] columnTypes = { Double.class, 
				Double.class,
				Double.class,
				Double.class,
				Double.class,
		...
		try {
			parser = new FileParser(files_location+filenam[10], delimiter,
numColHdrRows, false);
			checkMethods(parser,columnTypes);
		} catch(Exception e) {
	...
	public void testJunkBetweenSingleColHdrLineAndData() {
		...
		try {
			parser = new FileParser(files_location+filenam[11], delimiter,
numColHdrRows, false);
			checkMethods(parser,columnTypes);
		} catch(Exception e) {
	...
	public void testMultipleSingleDataTruncatedLines() {
		FileParser parser = null;
		String delimiter = ",";
		int numColHdrRows = 1;
		FileHeaderIsNull = false;
		...
		try {
			parser = new FileParser(files_location+filenam[12], delimiter,
numColHdrRows, false);
			checkMethods(parser,columnTypes);
		} catch(Exception e) {
	...
	public void testMoreThanTwoConsequtiveTruncatedLines() {
		...
		try {
			parser = new FileParser(files_location+filenam[13], delimiter,
numColHdrRows, false);
			checkMethods(parser,columnTypes);
		} catch(Exception e) {
	...
	public void testOneHeaderLineOneDataLineWithBlankLineInBetween() {
		FileParser parser = null;
		String delimiter = ":";
		int numColHdrRows = 1;
		FileHeaderIsNull = false;
		...
		try {
			parser = new FileParser(files_location+filenam[14], delimiter,
numColHdrRows, false);
			checkMethods(parser,columnTypes);
		} catch(Exception e) {
	...
	public void testWrongDelimiterFoundInHeader() {
		...
		try {
			parser = new FileParser(files_location+filenam[15], delimiter,
numColHdrRows, false);
			checkMethods(parser,columnTypes);
		} catch(Exception e) {
...
numColHdrRows, false);
	...
	public void testLesserInputOfColHdrRowCount() {
	...
	FileParser parser = null;
        ...
        try {
		parser = new FileParser(files_location+filenam[16], delimiter,
numColHdrRows, false);
...
numColHdrRows, false);
	...
	public void testDataWithNaNs() {
		...
		try {
			parser = new FileParser(files_location+filenam[17], delimiter,
numColHdrRows, false);
			checkMethods(parser,columnTypes);
		} catch(Exception e) {
	...
	public void testDataInQuotes() {
		...
		try {
			parser = new FileParser(files_location+filenam[18], delimiter,
numColHdrRows, false);
			checkMethods(parser,columnTypes);
		} catch(Exception e) {
	...
	if(LoggerIsEmpty)
		...
		if((parser.getLogMessages()).length()==0)
			assertEquals(true, false);
