...
/**
 * <p>Description: A table with the column name in column 0 and a boolean check
 * box in column 1. This allows the user to select and deselect items in the
 * table. We may expand this later to accept multiple column names for one
 * row. This woudl be used to support the multiple header rows in the main
 * table application</p>
...
public class ColumnSelectionTable extends JTable
{
   ...
   /** The sorting table model. Note that I could not use the larger
    * SortingTableModel because it extends MultiRowHeaderModel.*/
    ...
    *
    * @param columnHeaders String[] with the headers of the columns in the
    *    application table.
    * @param selected boolean[] with true values for any selected columns. Must
    *    be the same length as columnNames;
    */
   ...
   /**
    * Constructor.
    * @param localColumn String[] with the names of the columns in this table.
    * @param columnHeaders String[] with the headers of the columns in the
    *    application table.
    * @param selected boolean[] with true values for any selected columns. Must
    *    be the same length as columnNames;
    */
   public ColumnSelectionTable(String[] localColumns, String[][] columnHeaders,
                               boolean[] selected)
   {
   ...
   /**
    * Get the columns that are checked in the order that they were passed in.
   ...
   /**
    * Return the String for all columns except the last one. Return Boolean
    * for the last column.
    * @param col int that is the column for which the class is requested.
    * @return Class
    */
    ...
    * @param row int that is the row where the cell is.
    * @param col int that is the column where the cell is.
