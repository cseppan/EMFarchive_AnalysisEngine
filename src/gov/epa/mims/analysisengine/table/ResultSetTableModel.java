 ...
 * <p>Description: A table model with a java.sql.ResultSet as a data model</p>
 * <p>Copyright: Copyright (c) 2003</p>
 * <p>Company: CEP, UNC-Chapel Hill </p>
 * @author Prashant Pai
 * @version $Id: ResultSetTableModel.java,v 1.1 2005/09/19 14:14:04 rhavaldar Exp $
 */
public class ResultSetTableModel extends SpecialTableModel
{
   ...
   /**
    * Store a reference to the DataSetIfc's passed in. I think that you'll have
    * to store a pointer to each DataSetIfc in a DataSetIfc[] array.
    * Set up column names based on the names of the data sets.
    * Get and store the number or rows in the longest DataSetIfc.
    * @param dataSets
    */
   ...
   public String getColumnName(int col)
   {
      try
      {
         ...
         if(col >= length)
         {
            ...
            col + " > maximum column in the table model:"+length ,
   ...
   /**
    * Go to the DataSetIfc at the columnIndex and get the value at rowIndex from it.
    * If the given row is greater than the number of items in the DataSetIc,
    * then return "n/a".
    */
   public Object getValueAt(int rowIndex, int columnIndex)
   {
      ...
      try
      {
         ...
         if(columnIndex >= length)
         {
            ...
            " > maximum column in the table model: "+length);
         }
         ...
         if(rowIndex >= rowCount)
         {
            ...
            " > maximum rows in the table model: "+rowCount);
         }
         if(rowIndex < rowCount)
         {
            aElement = null;
      ...
      {
         DefaultUserInteractor.get().notify(null,"Error",
         "A error in DataSetsTableModel.getValueAt()"+ e.getMessage(),
         UserInteractor.ERROR);
         e.printStackTrace();
      }
   ...
   /**
    * The DataSetIfc's might have differing numbers of rows, so return the
    * length of the longest DataSetIfc.
    */
   ...
   public static void main(String arg[])
   {
      ...
      TableApp table = new TableApp(rs,"Query1");
