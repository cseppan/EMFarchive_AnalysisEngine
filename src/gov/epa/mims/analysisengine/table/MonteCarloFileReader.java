...
public class MonteCarloFileReader extends FileParser
{
   ...
   /** will break a word into two words if that word contain "in".
    * If "aWord" does not contain "in" then it will return String array with
    * "aWord" with that empty string.
    * @param aWord
