...
/**
 * <p>Title:StatisticsModel.java </p>
 * <p>Description: A data model for the statistics gui
 * <p>Copyright: Copyright (c) 2004</p>
 * <p>Company: CEP, UNC-Chapel Hill </p>
 * @author Parthee Partheepan
 * @version $Id: StatisticsModel.java,v 1.2 2005/09/19 14:50:03 rhavaldar Exp $
 * Handles columns of types Double and Integer
*/
...
public class StatisticsModel
{
   ...
   /** An array of booleans to indicate which columns are selected for the
   ...
   /** a counter to track the no of basic stats analysis created during a model run and used
   * in creating the tab name
   */
  ...
  public String getDataColumnSelection()
  {
   ...
   /** Setter for property showColumns and then create dataColumns array
    * and selectedColNames
    * The size of the dataColumn& selectedColNames arrays is equal to number of
    * true value in the showColumns columns.
    * @param showColumns New value of property showColumns.
    *
    */
    ...
    * based on the selected data columns (of type Double and Integer)
    */
   public Object[][] calculateBasicStatistics() throws Exception
   {
      if(dataColumns != null)
      {
         ...
         for(int i=0; i < noOfColSelected; i++)
         {
            ...
            {
               throw new Exception("The selected column " + selColIndex +
               " type is not numeric.\nPlease only select the columns with " +
               "type numeric");
            }//if()*/
            //store the col data
...
//System.out.println("colData ["+r+ "]="+colData[r]);
    ...
    * @param selBasicStats New value of property selBasicStats.
    *
    */
   ...
   public DataSetsAdapter createDataSets() throws Exception
   {
      ...
      for (int i = 0; i < dataColumns.length; i++)
      {
         dataSeries = new TableDataSeries(overallTableModel,dataColumns[i],
   ...
   * @return int[] consisit of indices corresponding to the elements in the selected
   * which have true value.
   */
...
//System.out.println("selections[j]="+selections[j]);
  ...
  /** Getter for property percentileModel.
s   * @return Value of property percentileModel.
   *
   */
 ...
 /** Setter for property histogramModel.
   * @param histogramModel New value of property histogramModel.
   *
   */
   ...
   * @param percentileModel New value of property percentileModel.
   *
   */
  ...
  /** Setter for property percentileModel.
   * @param regressionModel New value of property regressionModel.
   *
   */
   ...
   * @param histogramAnalysis New value of property histogramAnalysis.
   *
   */
   ...
   * @param percentileAnalysis New value of property percentileAnalysis.
   *
   */
   ...
   * @param regressionAnalysis New value of property regressionAnalysis.
   *
   */
   ...
   * @param correlationAnalysis new value
   *
   */
   ...
   * @param selectedColNames New value of property selectedColNames.
   *
   */
   ...
   * @param basicStatsAnalysis New value of property basicStatsAnalysis.
   *
   */
   ...
   * @param basicStatsTabName New value of property basicStatsTabName.
   *
   */
