...
public class SortCriteria implements java.io.Serializable
{
   ...
   /** An element is true if the matching column in the columns array should
   ...
   /** Boolean array where an element is true if the sorting should be case
    * sensitive for the given column. */
   private boolean[] caseSensitive = null;

   /**
    * Constructor.
    *
    * @param columns String[] that contains the names of the columns to sort.
    * @param ascending boolean[] that is true if the given column should be
    *    sorted in ascending order.
    * @param caseSensitive boolean[] that is true if the given column should be
    *    sorted case sensitive.
    * @throws IllegalArgumentException if the lengths of the three arguemnt
    *    arrays are net equal or are null.
    */
   public SortCriteria(String[] columnNames, boolean[] ascending,
                       boolean[] caseSensitive)
   {
      ...
      if (columnNames == null)
      {
         throw new IllegalArgumentException(
               "columnnNamescanont be null in SortCriteria().");
      }
      ...
      if (columnNames.length != ascending.length ||
          columnNames.length != caseSensitive.length)
      {
         throw new IllegalArgumentException(
               "columnnNames, ascending and caseSensitive must all have the " +
    ...
    * @return boolean[] with true values for each column that should be sorted
    *  in ascending order.
    */
    ...
    * @return boolean[] that contains a true value if the column should be
    *    sorted case sensitive.
    */
   ...
   public SortCriteria checkCompatibility(OverallTableModel model) throws Exception
   {
        ...
        else if(count < columnNames.length)
        {
            ...
            DefaultUserInteractor.get().notify(null,"Sort Criteria","The table does not " +
            "contain " + missingColNames + " specified for sort criteria in the" + 
