...
/**
 * <p>Description: A table model that can store multi-row header informatoin. </p>
...
{
   /** The list of column headers. This is the transpose of the array passed
    * into the constructor. Each String[] is the header information for
    * one column. */
   protected String[][] columnHeaders = null;

   /** The headers that go in the upper right of the table and act as
    * row headers for the column names. */
   ...
   public MultiRowHeaderTableModel()
  {
   ...
   /**
    * Constructor.
    * @param MultiRowHeaderTableModel that is beneath this one.
    */
   ...
   * Constructor.
    *
    * @param columnRowHeaders String[] with the row headings for each column
    *    header row.
    * @param columnHeaders String that is the list of column headers and
    *   each String[] is one row of headers.
    */
    ...
    * @param col int the column for which to return the Class of objects.
   ...
   /**
    * Return the name of the column. This is the concatenation of all of the
    * column headers separated by a '|'.
    * @param col int that is the column index for the column name returned.
    */
...
/* Put this back after the demo
         StringBuffer sb = new StringBuffer();
         for (int i = 0; i < columnHeaders[col].length - 1; i++)
         {
            sb.append(columnHeaders[col][i]);
            sb.append(" | ");
         }
...
*/
   ...
   /**
    * Return the name of the column. This is the concatenation of the specified
    * row headers in the provided order by the specified separator
    * @param col int that is the column index for the column name returned.
    * @param colOrder the order in which the headers need to be added to the
    * column name
    * @param separator between the column headers
    */
   ...
   /**This method will be implemeted here if the data is altered other 
    *than filter and sorting operations.
...
} // class MultiRowHeaderTableModel
