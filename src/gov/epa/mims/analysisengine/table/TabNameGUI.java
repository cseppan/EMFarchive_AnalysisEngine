...
/**
 * <p>Title:TabNameGUI.java </p>
 * <p>Description: A gui for editing tab names</p>
 * <p>Copyright: Copyright (c) 2004</p>
 * <p>Company: CEP, UNC-Chapel Hill </p>
 * @author Parthee Partheepan
 * @version $Id: TabNameGUI.java,v 1.1 2005/09/19 14:14:04 rhavaldar Exp $
 */
...
public class TabNameGUI extends JDialog
{
    ...
    * the table whether the new tab name entered is an unique name
    */
       ...
       DefaultCellEditor cellEditor = new DefaultCellEditor(txtField)
       {
            ...
            // Override DefaultCellEditor's getCellEditorValue method
             ...
             public Object getCellEditorValue()
             {
               ...
               {
                  DefaultUserInteractor.get().notify(TabNameGUI.this,"Error", e.getMessage(),
   ...
   /** A helper method for checking whether the newName matches any names of
    * the tab
    */
   private void checkForUniqueNames(String newName) throws Exception
   {
      for(int i=0; i< allTabNames.length; i++)
      {
         ...
         {
            throw new Exception("The name \""+ newName + "\" is already exist in the"
               + " list of tab names");
         }
      }
   }
   ...
   public static void main(String[] args)
   {
      ...
      TabNameGUI tabNameGUI = new TabNameGUI(frame, tabNames);
      System.exit(0);
   }
