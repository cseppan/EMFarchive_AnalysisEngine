...
public class SLRResultTableModel extends SpecialTableModel {
    ...
    public SLRResultTableModel(Vector depVars, Vector indepVars, int numInstances, String
fileName) {
      super();
      ...
      dataHdr.append("\nDependent Variables: "+
RegressionGUI.getStringFromVector(depVars));
      dataHdr.append("\n Independent Variables: "+
RegressionGUI.getStringFromVector(indepVars));
      dataHdr.append("\n The following data shows only "+
        "the 1-to-1 correlation coefficient between each dependent"+
