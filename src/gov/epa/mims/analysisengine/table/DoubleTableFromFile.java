...
public class DoubleTableFromFile implements org.iscmem.cosu.DoubleTable
{
    ...
    *
    *  @param filename String
    *  @param headers  String[] containing the column headers
    *
    *  @throws Exception if the filename is invalid
    **/
   ...
   /** Indicate that the contents of the table will be accessed.  This
    *  must be called before any operation that access the contents.
    *  Each call to 'open' must be matched to a call to 'close'.
    *  It is permissible to call 'open' while the table is already open.
    ...
    *
    * @throws Exception if there are problems writing the table's contents
    **/
    ...
    * @throws TableException if the table is not open
    * @throws Exception if there are problems accessing the table's contents
    ...
    *
    *  @throws java.lang.IllegalArgumentException if an index is out of range
    *  @throws TableException if the table is not open
    *  @throws Exception if there are problems accessing the table's contents
    **/
   ...
   /**
    * Return the number at the given row and column. The number might be
    * Double.NaN.
    *
    *  @param rowIndex 0-based row index
    *
    ...
    *
    *  @throws java.lang.IllegalArgumentException if an index is out of range
    * @throws TableException if the table is not open or if the column
    *       does not contain a <code>double</code> (for derived table classes)
    *  @throws Exception if there are problems accessing the table's contents
    **/
   ...
   /**
    * Return the numbers in the given row, one for each column
    * in the table. The numbers might be Double.NaN.
    *
    *  @param rowIndex 0-based row index
    *
    *  @throws java.lang.IllegalArgumentException if an index is out of range
    * @throws TableException if the table is not open or if all columns
    *       do not contain a <code>double</code> (for derived table classes)
    *  @throws Exception if there are problems accessing the table's contents
    **/
   ...
   /**
    * Return the name for the given row, which might be null if the name has
    * not been set.
    *
    *  @param rowIndex 0-based row index
    *
   ...
   /**
    * Return the 0-based index of the row with the given name or a negative number
    * if the name was not found. Name comparisons will respect case.
    * @throws TableException if the table is not open
    * @throws Exception if there are problems accessing the table's contents
    **/
   ...
   /**
    * Return the 0-based index of the column with the given name or a negative number
    * if the name was not found. Name comparisons will respect case.
    * @throws TableException if the table is not open
    * @throws Exception if there are problems accessing the table's contents
    **/
   ...
   /**
    * Put a value in the table. Any values previously stored in other rows
    ...
    *  @param columnIndex 0-based column index
    *
    * @param aValue double value for the cell
    *
    *  @throws java.lang.IllegalArgumentException if an index is out of range
    *  @throws TableException if the table is not open
    *  @throws Exception if there are problems accessing the table's contents
    */
   public void setDoubleAt(int rowIndex, int columnIndex, double aValue)
      throws Exception
   {
      if( rowIndex<0 || columnIndex<0 || rowIndex>=getRowCount() || columnIndex>=getColumnCount() )
      {
   ...
   /**
    * Fill a row in the table. Any values previously stored in other rows
    * will be written to persistent storage.
    *
    *  @param rowIndex 0-based row index
    *
    *  @param values double[] containing a values for row
    *
    *  @throws java.lang.IllegalArgumentException if an index is out of range
    *  @throws TableException if the table is not open
    *  @throws Exception if there are problems accessing the table's contents
    **/
   public void setDoubles(int rowIndex,double values[])
      throws Exception
   {
      if( rowIndex<0 || rowIndex>=getRowCount() )
      {
    ...
    *  @param rowIndex 0-based row index
    *
    *  @param header String header for row
    *  @param values double[] containing a values for row
    *
    *  @throws java.lang.IllegalArgumentException if an index is out of range
    *  @throws TableException if the table is not open
    *  @throws Exception if there are problems accessing the table's contents
    **/
   public void insertRow(int rowIndex, String header, double values[])
      throws Exception
   {
      if( rowIndex<0 || rowIndex>=getRowCount() )
      {
    ...
    *  @throws Exception if there are problems accessing the table's contents
    **/
   public void appendRow( String header, double values[])
      throws Exception
   {
      if( !isOpen )
      {
