 ...
 * @author Daniel Gatti
 * @version $Id: HistogramTest.java,v 1.2 2005/09/19 14:50:15 rhavaldar Exp $
 */
public class HistogramTest extends TestCase
{
    ...
    */
   public void testValuesAtBreakpoints()
   {
      try
      {
         // Frequency
    ...
    * <b> RUN WITH ajva -Xmx512m  OR YOU WILL GET OUT OF MEMORY ERRORS!</b>
    * @param args not used
    ********************************************************/
   public static void main(String[] args)
   {
      junit.swingui.TestRunner.run(HistogramTest.class);
   }
} // class HistogramTest
