 ...
 ********************************************************/
public class SubTitleCmd extends TextCmd
{
   /**
    * Creates a new TitleCmd object.
    * @param side DOCUMENT_ME
    ********************************************************/
   public SubTitleCmd(Text t)
   {
      super(t);
   }
   ...
   public List getCommands()
   {
      ...
      t = Util.textOverRide(t, Text.TOP_HAND_MARGIN, Text.SOUTH, 0.5, 0.5);
      super.setText(t);
