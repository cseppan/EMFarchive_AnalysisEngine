 ...
 * @version $Id: DoubleSeries.java,v 1.1 2005/09/19 14:14:10 rhavaldar Exp $
 *
 *****************************************************/
                                                             ...
                                                             Cloneable
{
   ...
   public boolean equals(Object o)
   {
      ...
      else
      {
         ...
         rtrn = gov.epa.mims.analysisengine.tree.Util.equals(dataArrayList, 
                                                             other.dataArrayList);
      }
    ...
    * store the data
    *
    * @param data the actual data for this data series
    * @data != null
    *****************************************************/
    ...
    * @throws java.lang.Exception if DoubleSeries is not open
    * @throws java.util.NoSuchElementException if i is out of range
    * @return the i-th data element
    *****************************************************/
   public double getElement(int i) throws java.util.NoSuchElementException, 
                                          java.lang.Exception
   {
