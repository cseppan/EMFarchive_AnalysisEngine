              ...
              AnalysisOptionConstantsIfc
{
   ...
   public void printChildren(Object o)
   {
      ...
      String shortname = c1name.substring(c1name.lastIndexOf('.') + 1);

      ((gov.epa.mims.analysisengine.tree.VisitableIfc) o).accept(this);
   ...
   //   {
   //      System.out.println("printField(String s): " + s.toString());
   //   }
   //
   //   public void printField(Object o)
   //   {
   //      System.out.println("printField(Object o): " + o.toString());
   //   }
   ...
   /**
      public static void main(String[] args)
      {
         ...
         options.addOption(LINE_TYPE,new LineType());
         dataSets.add(options);
         options.add(page);
         page.add(scatterPlot);
         PrintVisitor c = new PrintVisitor();
         c.printChildren(dataSets);
   ...
   **/
   ...
   /**
      ...
      {
         gov.epa.mims.analysisengine.tree.test.DoubleSeries ds
          = new gov.epa.mims.analysisengine.tree.test.DoubleSeries();
