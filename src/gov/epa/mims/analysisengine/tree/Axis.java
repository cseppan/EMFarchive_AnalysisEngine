...
/**
 * Abstract base class for all AnalysisOption Axes. It holds parameters
 * which are common to all axes. Such as position, color, tickmark and
 * label parameters. setAxisRange(java.lang.Object, java.lang.Object) is
 * abstract and must be implemented by concrete subclasses.
 *
 * @author Tommy E. Cathey
 * @version $Id: Axis.java,v 1.2 2005/09/19 14:50:10 rhavaldar Exp $
 *
 **/
              ...
              TextIfc
{
    ...
    * <li>the interpretation of {@link #position} will depend on the value
    * of {@link #positioningAlgorithm}
    * </ul>
    */
    ...
    * <p>sets {@link #axisColor}
    * <p>Example of a Color.blue axis
    * <p><IMG BORDER="3" SRC="doc-files/Axis1.jpg">
    *
    * @param arg desired color of axis
    * @see #getAxisColor()
    ******************************************************/
    ...
    * <p>Example of a Color.red axis label
    * <p><IMG BORDER="3" SRC="doc-files/Axis1.jpg">
    * <p>The label is automatically centered in the plot margin
    * however the user can override the position and formatting
    * by setting options in {@link Text}
    *
    * @param arg string to use as text label
   ...
   {
      return (axisLabelText != null)
             ? (Text) axisLabelText.clone()
             : null;
   }
    ...
    *
    * @param min min point in axis range
    * @param max max point in axis range
    ********************************************************/
    ...
    * <p>"false" causes the labels to be displayed parallel to the axis
    * <p><IMG BORDER="3" SRC="doc-files/Axis1.jpg">
    * <p>"true" causes the labels to be displayed perpendicular to the axis
    * <p><IMG BORDER="3" SRC="doc-files/Axis2.jpg">
    *
    * @param arg true->perpendicular to the axis; false->parallel to the axis
    ...
    * <p><IMG BORDER="3" SRC="doc-files/Axis3.jpg">
    * <li>false - do NOT draw the axis tick marks
    * <p><IMG BORDER="3" SRC="doc-files/Axis6.jpg">
    * </ul>
    *
    * @param arg true->draw the axis tick marks;
    *            false->do not draw the axis tick marks
    ...
    * </ul>
    *
    * @param flg true->draw; false->do not draw
    * @see #getEnableAxis()
    ********************************************************/
    ...
    * <li>{@link #USER_COORDINATES} then location is in user coordinates
    * Example of positioning the y-axis at -2.3 in user space
    * <IMG BORDER="3" SRC="doc-files/Axis5.jpg">
    ...
    * <li>Note that linesIntoMargin does not affect the axis label
    * positioning. Also, negative values are allowed
    * </ul>
    * </ul>
    *
    * @param algorithm {@link #DEFAULT_POSITIONING} {@link #USER_COORDINATES}
    * {@link #LINES_INTO_MARGIN}
    * @param arg the value of the Axis position
    * @see #getPosition()
    ...
    * <p>Valid values are:
    * <p>{@link FontConstantsIfc#PLAIN_TEXT}
    * <p><IMG BORDER="3" SRC="doc-files/Axis7.jpg">
    * <p>{@link FontConstantsIfc#BOLD_TEXT}
    * <p><IMG BORDER="3" SRC="doc-files/Axis8.jpg">
    * <p>{@link FontConstantsIfc#ITALIC_TEXT}
    * <p><IMG BORDER="3" SRC="doc-files/Axis9.jpg">
    * <p>{@link FontConstantsIfc#BOLD_ITALIC_TEXT}
    * <p><IMG BORDER="3" SRC="doc-files/Axis10.jpg">
    * @param arg desired tick mark font
    ******************************************************/
    ...
    * <p>Example of Color.green tick mark labels
    * <p><IMG BORDER="3" SRC="doc-files/Axis1.jpg">
    *
    * @param arg desired color of tick mark labels
    * @pre arg != null
    ******************************************************/
    ...
    * <p>causes tick mark labels to be scaled
    * <p>Example: expansion = 0.75
    * <p><IMG BORDER="3" SRC="doc-files/AxisTickMarkLabelExpansion075.jpg">
    *
    * <p>Example: expansion = 1.0
    * <p><IMG BORDER="3" SRC="doc-files/AxisTickMarkLabelExpansion10.jpg">
    *
    * <p>Example: expansion = 1.5
    * <p><IMG BORDER="3" SRC="doc-files/AxisTickMarkLabelExpansion15.jpg">
    *
    * @param arg the desired tick mark label expansion coefficient
    ******************************************************/
    ...
    *
    * @pre arg != null
    * @param arg String array of user selected tick mark labels
    ******************************************************/
    ...
    * <p>NOT IMPLEMENTED
    * @pre arg != null
    * @param arg array of user selected tick mark positions
    ******************************************************/
                ...
                throws CloneNotSupportedException
   {
      ...
      clone.axisLabelText = (clone.axisLabelText == null)
                            ? null
                            : (Text) axisLabelText.clone();

      double[] tmp = (clone.userTickMarkPositions == null)
                     ? null
                     : (double[]) userTickMarkPositions.clone();
      clone.userTickMarkPositions = tmp;

      clone.userTickMarkLabels = (clone.userTickMarkLabels == null)
                                 ? null
                                 : (String[]) userTickMarkLabels.clone();
   ...
   public boolean equals(Object o)
   {
      ...
      else
      {
         ...
         rtrn = ((position == other.position)
                ...
                && ((axisColor == null)
                    ? (other.axisColor == null)
                    : (axisColor.equals(other.axisColor)))
                && (drawTickMarks == other.drawTickMarks)
                && (drawTickMarkLabels == other.drawTickMarkLabels)
                && (b == bOther)
                && ((tickMarkLabelColor == null)
                    ? (other.tickMarkLabelColor == null)
                    : (tickMarkLabelColor.equals(other.tickMarkLabelColor)))
                && ((tickMarkFont == null)
                    ? (other.tickMarkFont == null)
                    : (tickMarkFont.equals(other.tickMarkFont)))
                && (tickMarkLabelExpansion == other.tickMarkLabelExpansion)
                && Util.equals(userTickMarkPositions,
                               other.userTickMarkPositions)
                && Util.equals(userTickMarkLabels, other.userTickMarkLabels));
      }
