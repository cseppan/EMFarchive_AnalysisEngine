   ...
   implements Serializable
{
    ...
    *
    * @param plotTypeName plot type name
    * @param plotClass class of this plot type
    * @param allKeywords allowed AnlysisOption keywords for this plot type
    * @param dataSetInfos array of DataSetInfo for this plot type
    ********************************************************/
   public PlotInfo(String plotTypeName, Class plotClass, String[] allKeywords, 
   ...
   {
      return (dataSetInfos != null)
             ? (DataSetInfo[]) dataSetInfos.clone()
             : null;
   }
   ...
   public boolean equals(Object o)
   {
      ...
      else
      {
         ...
         rtrn = ((plotTypeName == null)
                 ? (other.plotTypeName == null)
                 : (plotTypeName.equals(other.plotTypeName)))
                && (plotClass == other.plotClass)
                && Util.equals(dataSetInfos, other.dataSetInfos);
      }
