...
/**
 * <p>This class traveres the tree and keeps track of
 * how many pages and plots there are as well as the number of each
 * type of plot. It provides access methods to get this information once
 * the tree has been traversed. </p>
 *
...
public class TreeSummary extends Visitor
{
   ...
   /**
    * Given a non-null tree, traverse it and count the number of pages
    * and the number of each type of plot.
    *
    * @param tree Branch that is the root of a tree. (Cannot be null)
    */
    ...
    *
    * @param plotName String that <b>must</b> be one of the
    *  plot types in
   ...
   public int getCountForPlot(String plotName)
   {
      ...
      if (count == null)
         throw new IllegalArgumentException("The plot name " + plotName +
               "is not a recognized plot type in " + getClass().toString() +
               ".getPlotCountForPlot()");
