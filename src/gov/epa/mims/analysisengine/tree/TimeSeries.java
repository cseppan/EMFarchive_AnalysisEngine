 ...
 * <br><A HREF="doc-files/ExampleTimeSeriesAxisGrid17.html"><B>View Example</B></A>
 * <br><A HREF="doc-files/ExampleTimeSeriesAxisGrid18.html"><B>View Example</B></A>
 * <br><A HREF="doc-files/ExampleTimeSeriesAxisGrid11.html"><B>View Example</B></A>
 * <br><A HREF="doc-files/ExampleTimeSeriesAxisGrid12.html"><B>View Example</B></A>
 * <br><A HREF="doc-files/ExampleTimeSeriesAxisGrid13.html"><B>View Example</B></A>
 * <br><A HREF="doc-files/ExampleTimeSeriesAxisGrid14.html"><B>View Example</B></A>
 * <br><A HREF="doc-files/ExampleTimeSeriesAxisGrid06.html"><B>View Example</B></A>
 * <br><A HREF="doc-files/ExampleTimeSeriesAxisGrid07.html"><B>View Example</B></A>
 * <br><A HREF="doc-files/ExampleTimeSeriesAxisGrid08.html"><B>View Example</B></A>
 * <br><A HREF="doc-files/ExampleTimeSeriesAxisGrid09.html"><B>View Example</B></A>
 * <br><A HREF="doc-files/ExampleTimeSeriesAxisGrid10.html"><B>View Example</B></A>
 * <br><A HREF="doc-files/ExampleTimeSeriesAxisGrid01.html"><B>View Example</B></A>
 * <br><A HREF="doc-files/ExampleTimeSeriesAxisGrid05.html"><B>View Example</B></A>
 **/
              ...
              AnalysisOptionConstantsIfc
{
    ...
    * {@link TimeSeries#setDataSetKeys(Object[])}
    */
   ...
   **/
   ...
   public Object clone()
   {
      try
      {
         ...
         clone.keys = (keys == null)
                      ? null
                      : (Object[]) keys.clone();
         clone.keyList = (keyList == null)
                         ? null
                         : (ArrayList) keyList.clone();
   ...
   /**
    * create the data set keys from an array of dataSets then call
    * setDataSetKeys
...
/**      
      Vector data = ((DataSets)dataSets.get(0)).getDataSets(null,null);
      //checking the length
      int currLength = -1;
      Date prevDate = null;
      Date dateK =  new Date((long)-1e14); //just set it to a very low value(Thu Feb 26 09:13:20 EST 1200)
      Date dateI = null;
      boolean checkLength = true;
      DateDataSetIfc dateSetIfc0 = (DateDataSetIfc)data.get(0);
      dateSetIfc0.open();
      int length0 = dateSetIfc0.getNumElements();

      for(int k=0; k< length0; k++)
      {
         prevDate = dateK;
         dateK = dateSetIfc0.getDate(k);
         if(!prevDate.before(dateK))
         {
            throw new Exception("The dates in a date dataset should be in an " +
               "ascending order" );
         }//if(!prevDate.before(dateK))

         for(int m=1; m< data.size(); m++)
         {
            DateDataSetIfc dateSetIfc = (DateDataSetIfc)data.get(m);
            dateSetIfc.open();
            if(checkLength)
            {
               currLength = dateSetIfc.getNumElements();
               if(currLength != length0)
               {
                  throw new Exception("The number of elements in datasets, \""
                     + dateSetIfc.getName() +"\", \""+dateSetIfc0.getName()+ "\" are not equal." );
               }//if(currLength != prevLength)
            }//if(checkLength)
            dateI = dateSetIfc.getDate(k);
            if(!dateK.equals(dateI))
            {
               throw new Exception("The date labels for the selected datasets are not " +
                  "same across the datasets");
            }
            dateSetIfc.close();
         }//for(m)
         checkLength = false;
...
*/      
   ...
   private static void initPlotInfo()
   {
      ...
      dataSetInfos[0] = new DataSetInfo("Time Series Data",
                                        DateDataSetIfc.class, 1, -1);
      plotInfo = new PlotInfo(AnalysisEngineConstants.TIME_SERIES_PLOT,
                              TimeSeries.class, allKeywords, dataSetInfos);
   }
}