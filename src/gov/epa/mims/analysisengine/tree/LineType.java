 ...
 * It is used as an argument in {@link AnalysisOptions#addOption(java.lang.String
 * key, java.lang.Object obj) } <p>
 *
 ...
 * @version $Id: LineType.java,v 1.2 2005/09/19 14:50:10 rhavaldar Exp $
 *
 **/
   ...
   AnalysisOptionConstantsIfc
{
    ...
    *   <li> Alternatively, a string of up to 8 characters (from 0:9, "A":"F")
    *   may be given, giving the length of line segments which are alternatively
    *   drawn and skipped. Used cyclically. NOTE: mixing named types with the up
    *   to 8 characters string types can be problematic when generating legends.
    *
    * </ul>
    * <br>
   ...
   /**
    * set array of line widths; used cyclically <p>
    *
    * <br>
    * <A HREF="doc-files/ExampleLineType07.html"><B>View Example</B> </A> <br>
    * <A HREF="doc-files/ExampleLineType08.html"><B>View Example</B> </A>
    *
    * @param arg  array of line widths; used cyclically
    * @pre        arg != null
    */
   ...
   /**
    * set the plot style <p>
    *
    * valid values are:
    * <ul>
    *   <li> {@link LineType#LINES} <A HREF="doc-files/ExampleLineType01.html">
    *   <B>View Example</B> </A>
    *   <li> {@link LineType#POINTS} <A HREF="doc-files/ExampleLineType02.html">
    *   <B>View Example</B> </A>
    *   <li> {@link LineType#POINTS_N_LINES} <A
    *   HREF="doc-files/ExampleLineType03.html"><B>View Example</B> </A>
    *   <li> {@link LineType#NO_PLOTTING} <A
    *   HREF="doc-files/ExampleLineType04.html"><B>View Example</B> </A>
    *   <li> Default <A HREF="doc-files/ExampleLineType07.html"><B>View Example
    *   </B></A>
    * </ul>
    *
    *
    * @param arg  the plot style
    * @pre        arg != null
    */
   ...
   /**
    * set array of symbols; used cyclically <p>
    *
    *
    * <ul>
    ...
    *   <li> Character Symbols "!", "@", "#", "$", "%", "^", "&", "*", "(", ")",
    *   "_", "-", "+", "=", "|", "\", ":", ";", "?", "/", lower case letters "a"
    *   to "z", or upper case letters "A" to "Z" NOTE: mixing named symbols with
   ...
   /**
    * retrieve array of symbols; used cyclically <p>
    *
    *
    * <ul>
    *   <li> {@link LineType#CIRCLE}
   ...
   /**
    * set the symbol expansion coefficient array <p>
    *
    * <A HREF="doc-files/ExampleLineType07.html"><B>View Example</B> </A> <br>
    * <A HREF="doc-files/ExampleLineType13.html"><B>View Example</B> </A>
    *
    * @param arg  symbol expansion coefficient array
    * @pre        arg != null
    */
   ...
   public boolean equals(Object o)
   {
      ...
      else
      {
         ...
         rtrn = ((plotStyle == null)
             ? (other.plotStyle == null)
             : (plotStyle.equals(other.plotStyle)))
             && Util.equals(lineStyle, other.lineStyle)
             && Util.equals(lineWidth, other.lineWidth)
             && Util.equals(symbol, other.symbol)
             && Util.equals(symbolExpansion, other.symbolExpansion)
