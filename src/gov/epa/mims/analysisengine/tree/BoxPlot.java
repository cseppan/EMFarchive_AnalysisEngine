              ...
              AnalysisOptionConstantsIfc
{
    ...
    * {@link BoxPlot#setDataSetKeys(Object[])}
    */
   ...
   private static void initPlotInfo()
   {
      ...
      dataSetInfos[0] = new DataSetInfo("Box Data Series", DataSetIfc.class, 1,
                                        -1);
      plotInfo = new PlotInfo(AnalysisEngineConstants.BOX_PLOT, BoxPlot.class,
