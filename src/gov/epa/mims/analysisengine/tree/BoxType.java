 ...
 * </pre>
 *
 * <br><A HREF="doc-files/ExampleBoxPlot00.html"><B>View Example</B></A>
 * <br><A HREF="doc-files/ExampleBoxPlot01.html"><B>View Example</B></A>
 * <br><A HREF="doc-files/ExampleBoxPlot02.html"><B>View Example</B></A>
 * <br><A HREF="doc-files/ExampleBoxPlot03.html"><B>View Example</B></A>
 * <br><A HREF="doc-files/ExampleBoxPlot04.html"><B>View Example</B></A>
 * <br><A HREF="doc-files/ExampleBoxPlot05.html"><B>View Example</B></A>
 * <br><A HREF="doc-files/ExampleBoxPlot06.html"><B>View Example</B></A>
 * <br><A HREF="doc-files/ExampleBoxPlot07.html"><B>View Example</B></A>
 * <br><A HREF="doc-files/ExampleBoxPlot08.html"><B>View Example</B></A>
 * <br><A HREF="doc-files/ExampleBoxPlot20.html"><B>View Example</B></A>
 * <br><A HREF="doc-files/ExampleBoxPlot50.html"><B>View Example</B></A>
 * <br><A HREF="doc-files/ExampleBoxPlot51.html"><B>View Example</B></A>
 * <br><A HREF="doc-files/ExampleBoxPlot52.html"><B>View Example</B></A>
 * <br><A HREF="doc-files/ExampleBoxPlot53.html"><B>View Example</B></A>
 * <br><A HREF="doc-files/ExampleBoxPlot54.html"><B>View Example</B></A>
 * <br><A HREF="doc-files/ExampleBoxPlot55.html"><B>View Example</B></A>
 * <br><A HREF="doc-files/ExampleBoxPlot56.html"><B>View Example</B></A>
 * <br><A HREF="doc-files/ExampleBoxPlot57.html"><B>View Example</B></A>
 * <br><A HREF="doc-files/ExampleBoxPlot58.html"><B>View Example</B></A>
 * <br><A HREF="doc-files/ExampleBoxPlot59.html"><B>View Example</B></A>
 * <br><A HREF="doc-files/ExampleBoxPlot60.html"><B>View Example</B></A>
 * <br><A HREF="doc-files/ExampleBoxPlot61.html"><B>View Example</B></A>
 * <br><A HREF="doc-files/ExampleBoxPlot62.html"><B>View Example</B></A>
 * <br><A HREF="doc-files/ExampleBoxPlot63.html"><B>View Example</B></A>
 * <br><A HREF="doc-files/ExampleBoxPlot64.html"><B>View Example</B></A>
              ...
              ColorConstantsIfc
{
   ...
   /** flag to generate boxes of variable widths based on the number of
    * observations
    */
    ...
    * <br><A HREF="doc-files/ExampleBoxPlot55.html"><B>View Example</B></A>
    *
    * @param arg cyclic colors for box plot interiors
    ********************************************************/
   ...
   /**
    * set the custom percentiles used when 
    * custom processing is set in
    * setProcessing(BoxPlotConstantsIfc.CUSTOM)
    * <p>
    * <br>
    ...
    * </ul>
    * @param customPercentiles percentiles
    ********************************************************/
    ...
    * </ul>
    *
    * @param arg user selected orientation flag
    ******************************************************/
    ...
    * <br><A HREF="doc-files/ExampleBoxPlot56.html"><B>View Example</B></A>
    *
    * @param arg widths of the box plots
    ********************************************************/
   ...
   public Object clone()
   {
      try
      {
         ...
         clone.color = (color == null)
                       ? null
                       : (Color[]) color.clone();
         clone.width = (width == null)
                       ? null
                       : (double[]) width.clone();
         clone.boxwex = (boxwex == null)
                        ? null
                        : (double[]) boxwex.clone();
         clone.at = (at == null)
                    ? null
   ...
   public boolean equals(Object o)
   {
      ...
      else
      {
         ...
         rtrn = Util.equals(width, other.width)
                ...
                && Util.equals(notch, other.notch)
                && Util.equals(varwidths, other.varwidths)
                && Util.equals(outliers, other.outliers)
                && Util.equals(horizontal, other.horizontal)
                && Util.equals(boxwex, other.boxwex)
                && Util.equals(notchFrac, other.notchFrac)
                && Util.equals(lwd, other.lwd) && Util.equals(at, other.at)
                && Util.equals(range, other.range)
    ...
    * <br>
    * <ul>
    * <li>true - draw notched boxes
    * <br><A HREF="doc-files/ExampleBoxPlot62.html"><B>View Example</B></A>
    * <li>false - draw rectangular boxes
    * <br><A HREF="doc-files/ExampleBoxPlot53.html"><B>View Example</B></A>
    * </ul>
    * <br>
    * @param arg notch flag
    ********************************************************/
    ...
    * <br>
    * <ul>
    * <li>true - the widths are determined by the number of data points
    * <br><A HREF="doc-files/ExampleBoxPlot08.html"><B>View Example</B></A>
    * <br><A HREF="doc-files/ExampleBoxPlot20.html"><B>View Example</B></A>
    * <br><A HREF="doc-files/ExampleBoxPlot54.html"><B>View Example</B></A>
    * <br><A HREF="doc-files/ExampleBoxPlot55.html"><B>View Example</B></A>
    ...
    * <br><A HREF="doc-files/ExampleBoxPlot63.html"><B>View Example</B></A>
    * <br><A HREF="doc-files/ExampleBoxPlot64.html"><B>View Example</B></A>
    * <li>false - the widths are uniform
    * <br><A HREF="doc-files/ExampleBoxPlot02.html"><B>View Example</B></A>
    * <br><A HREF="doc-files/ExampleBoxPlot03.html"><B>View Example</B></A>
    * <br><A HREF="doc-files/ExampleBoxPlot04.html"><B>View Example</B></A>
    * <br><A HREF="doc-files/ExampleBoxPlot05.html"><B>View Example</B></A>
    ...
    * <br>
    *
    * @param arg variable widths flag
    ********************************************************/
    ...
    * <br>
    * <ul>
    * <li>true - reverse the order of the box plots
    * <br><A HREF="doc-files/ExampleBoxPlot04.html"><B>View Example</B></A>
    * </ul>
    * <br>
    *
    * @param arg reverse order flag
    ********************************************************/
    ...
    * <li>false - do not draw the data outliers
    * <br><A HREF="doc-files/ExampleBoxPlot60.html"><B>View Example</B></A>
    * </ul>
    * <br>
    *
    * @param arg outlier flag
    ********************************************************/
    ...
    * <br><A HREF="doc-files/ExampleBoxPlot60.html"><B>View Example</B></A>
    *
    * @param arg box expansion factors
    ********************************************************/
   public void setBoxwex(double[] arg)
   {
      this.boxwex = (arg != null)
                    ? arg
                    : null;
   }
    ...
    * <br><A HREF="doc-files/ExampleBoxPlot63.html"><B>View Example</B></A>
    *
    * @param arg line width of the box plots
    ********************************************************/
   ...
   /**
    * set the range of the whiskers
    * <br>
    * <ul>from the R documentation:
    * <li>determines how far the plot whiskers extend out from the box. 
    ...
    * </ul>
    *
    * @param arg range of the whiskers
    ********************************************************/
    ...
    * <br>
    * <ul>
    * <li> the length of arg must equal the number of boxes
    * <br><A HREF="doc-files/ExampleBoxPlot64.html"><B>View Example</B></A>
    * <br><A HREF="doc-files/ExampleBoxPlot20.html"><B>View Example</B></A>
    * </ul>
    * <br>
    *
    * @param arg user selected locations of the box plots
    ********************************************************/
   ...
   public String toStringPretty(String separator)
   {
      ...
      b.append("range= " + range
               + "  (NOTE: range does not apply to LabeledDataSetIfc data)");
      b.append(separator);
