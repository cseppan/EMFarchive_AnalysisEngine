              ...
              PageConstantsIfc
{
   ...
   /**
    * array of all valid file formats which can be passed
    * to setForm(String) of a PageType object
    */
   ...
   // static initialization block
   {
      ...
      fileFormat = new String[] 
      {
         ...
         PDF, 
         POSTSCRIPT, 
         LATEX_PICTEX_GRAPHICS
      };
   }

   /**
    * retrieve valid file formats for page output; these are the
    * valid arguments for setForm(String) of PageType objects
    *
