 ...
 * </pre>
 *
 * <br><A HREF="doc-files/ExampleRankOrder01.html"><B>View Example</B></A>
 ...
 * @version $Id: RankOrderPlot.java,v 1.1 2005/09/19 14:14:13 rhavaldar Exp $
 *
 **/
public class RankOrderPlot
   extends Plot
              ...
              AnalysisOptionConstantsIfc
{
    ...
    * {@link RankOrderPlot#setDataSetKeys(Object[])}
    */
   ...
   ****************************************************************************/
   ...
   private static void initPlotInfo()
   {
      ...
      dataSetInfos[0] = new DataSetInfo("Y data series", DataSetIfc.class, 1,
                                        -1);
      ...
      //
      plotInfo = new PlotInfo(AnalysisEngineConstants.RANK_ORDER_PLOT,
                              RankOrderPlot.class, allKeywords, dataSetInfos);
   }
