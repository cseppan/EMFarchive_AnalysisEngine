              ...
              PageConstantsIfc
{
    ...
    * </pre>
    *
    * @param arg delete temporary file on exit flag
    ******************************************************/
    ...
    *
    * @param arg user selected pdf reader
    * @pre arg != null
    ******************************************************/
   ...
   public boolean equals(Object o)
   {
      ...
      else
      {
         ...
         rtrn = ((form == null)
                ...
                && ((pdfReader == null)
                    ? (other.pdfReader == null)
                    : (pdfReader.equals(other.pdfReader)))
    ...
    * @param textString String that is the filename to save the plot to.
    */
      ...
      String extension)
   {
      ...
      {
         String ending = filename.substring(filename.length()
                                            - extension.length());
   ...
   /**
    *
    * @param format String that is one of Page.JPEG, Page.LATEX_PICTEX_GRAPHICS,
    *    Page.PDF, Page.PNG_BITMAP or Page.POSTSCRIPT.
    ...
    * @param ext String that is one of the valid file extensions
    * @return String that is the format from PageConstantsIfc. Could be null
   ...
   /**
    * Is there a valid extension on the given filename?
    * We accept jpg, pdf, ptx, ps and png.
    * @param filename String whose extension should be checked.
   ...
   public static boolean isExtensionValid(String filename)
   {
      ...
      if (lastDot > 0)
      {
         ...
         return ((ext.equalsIgnoreCase(JPG_EXT))
                || (ext.equalsIgnoreCase(PTX_EXT))
                || (ext.equalsIgnoreCase(PDF_EXT))
                || (ext.equalsIgnoreCase(PNG_EXT))
                || (ext.equalsIgnoreCase(PS_EXT)));
      }
      else
      {
         return false;
