 ...
 * @version   $Id: AbstractDataSet.java,v 1.2 2005/09/19 14:50:10 rhavaldar Exp $
...

{
    ...
    * @param contentDescription  String a description of the contents of the
    ...
    * @param arg  the name to use for this data set
    ...
    * @param arg  data units for this data
    ...
    * @throws java.lang.CloneNotSupportedException  if super class is not
