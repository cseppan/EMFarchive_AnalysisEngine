...
/**
 * An analysis option which describes bar plot. It is passed to {@link
 * AnalysisOptions#addOption(java.lang.String key, java.lang.Object obj) } <p>
 *
   ...
   AnalysisOptionConstantsIfc
{
   ...
   /**
    * set to true if categories span data sets set to false if each data set is
    * its own category
    */
    ...
    *
    * @param alphabetize  The new alphabetize value
    */
   ...
   /**
    * Sets the borderColor attribute of the BarType object <p>
    *
    * <A HREF="doc-files/ExampleBarPlot12.html"> <B>View an example: false</B>
    * </A>
    *
...
//091504    }
    ...
    *
    * @param arg  The new categoriesSpanDataSets value
    */
...
//091504    }
   ...
   /**
    * set the categories span data sets flag <p>
    *
    * <A HREF="doc-files/ExampleBarPlot11.html"> <B>View an example: true</B>
    * </A> <p>
    *
    * <A HREF="doc-files/ExampleBarPlot12.html"> <B>View an example: false</B>
    * </A>
    *
    * @param arg  the categories span data sets flag
    */
    ...
    * <p>
    *
    * <A HREF="doc-files/ExampleBarPlot09.html"> <B>View an example: user
    * defined colors</B> </A> <p>
    *
    * <A HREF="doc-files/ExampleBarPlot10.html"> <B>View an example: default
    * colors</B> </A>
    *
    * @param arg  array of user selected colors for bars
    * @pre        arg != null
    */
    ...
    *
    * @param arg  user selected space between bars within a category
    */
    ...
    * <A HREF="doc-files/ExampleBarPlot05.html"><B>View an example</B> </A>
    *
    * @param arg  user selected space between categories
    */
    ...
    *
    * @param arg  true->stacked bars; false->nonstacked bars
    */
    ...
    *
    * @param arg  array of user selected bar widths
    * @pre        arg != null
    */
   ...
   public boolean equals(Object o)
   {
      ...
      else
      {
         ...
         rtrn = Util.equals(width, other.width)
             ...
             && (spaceBetweenCategories == other.spaceBetweenCategories)
             && (stacked == other.stacked)
             && (alphabetize == other.alphabetize)
