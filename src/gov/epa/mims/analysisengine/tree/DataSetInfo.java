...
public class DataSetInfo
{
    ...
    *
    * @param name name of data set "Category" - e.g. X, Y, ...
    * @param type Class of required data set
    * @param minNumber minimum number of data sets needed of this type
    * @param maxNumber maximum number of data sets needed of this type
    * or -1 if no maximum
    * The following Ranges are possible:
    * maxNumber >=  0   -->  [minNumber,maxNumber]
    * maxNumber == -1   -->  [minNumber,no limit)
    * @pre name != null
    * @pre type != null
    * @pre minNumber >= 0
   ...
   /**
    * retrieve maximum number of data sets needed of this type
    * or -1 if no maximum
    *
    * @return maximum number of data sets needed of this type
    * or -1 if no maximum
    ********************************************************/
    ...
    *
    * @param numberProvided number of data sets provided
    *
    * @return true if number is OK
    *
    * @throws Exception if number is NOT OK
    ********************************************************/
   public boolean validateNumber(int numberProvided)
                          throws Exception
   {
      if (numberProvided < minNumber)
      {
         throw new Exception(minNumber + " data sets of type " + name
                             + " are required for the plot, but "
                             + numberProvided + " were provided");
      }

      if ((maxNumber != -1) && (numberProvided > maxNumber))
      {
         throw new Exception(maxNumber + " data sets of type " + name
                             + " are allowed for the plot, but "
                             + numberProvided + " were provided");
      }
   ...
   private void setInfoString()
   {
      ...
      {
         infoString = Integer.toString(minNumber) + " to "
                      + Integer.toString(maxNumber) + " needed";
      }
   }
}