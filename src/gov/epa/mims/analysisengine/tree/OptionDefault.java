              ...
              AnalysisOptionConstantsIfc
{
    ...
    *
    * @param p DOCUMENT_ME
    * @param analysisOptionStr DOCUMENT_ME
    *
    * @return DOCUMENT_ME
    ********************************************************/
    ...
    *
    * @param p DOCUMENT_ME
    * @param analysisOption DOCUMENT_ME
    *
    * @return DOCUMENT_ME
    ********************************************************/
   private Class classLookUp(Plot p, String analysisOption)
   {
      Class c = AxisNumeric.class;
    ...
    * DOCUMENT_ME
    *
    * @param aPlot DOCUMENT_ME
    * @param analysisOptionClass DOCUMENT_ME
    *
    * @return DOCUMENT_ME
    ********************************************************/
   public Object getDefault(Plot aPlot, Class analysisOptionClass)
   {
      ...
      try
      {
         ...
         rtrnObj = m.invoke(this, 
                            new Object[] 
         {
            analysisOptionClass.newInstance()
         });
      }
   ...
   public static void main(String[] args)
   {
      ...
      options.addOption(X_NUMERIC_AXIS, 
                        new AxisNumeric());
