...
/**
 * An interface that contains the available data sets in the DataSets node if one
 * was provided. If no DataSets node was provided or it was null, then the
...
public interface DataSetsAdapter
{
    ...
    * @param dataSet the DataSetIfc to add
    * @param key the Object representing the key for the data set
    ...
    * @param dataSets the DataSetIfc [] to add
    * @param key the Object [] representing the keys for the data set
    * @throws IllegalArgumentException if something went wrong
    */
