 ...
 * @version $Id: Plot.java,v 1.2 2005/09/19 14:50:10 rhavaldar Exp $
 *
 ******************************************************/
              ...
              Cloneable
{
    ...
    * get a data series
    *
    * @param searchKey Object which serves as look up key
    * @return the object corresponding to given key
    *  null if not found
    * @pre searchKey != null
    ******************************************************/
   public DataSetIfc getDataSet(Object searchKey)
   {
      ...
      {
         dataSeries = ((DataSets) dataSetsAncestors.get(i)).getDataSet(
                            searchKey);
   ...
   *    sets were specified
   **/
   public abstract void setDataSetKeys(Object[] keys)
                                throws IllegalArgumentException;

   /**
    * abstract method for retrieving the plot name as defined
    * in gov.epa.mims.analysisengine.AnalysisEngineConstants
    *
    * @return plot name
    ********************************************************/
   ...
   public abstract void createDataSetKeys(ArrayList dataSets)
                                   throws Exception;
