   ...
   implements Serializable
{
    ...
    *
    * @param allKeywords array of available {@link AnalysisOptions}
    ********************************************************/
   ...
   {
      return (allKeywords == null)
             ? null
             : (String[]) allKeywords.clone();
   }

   /**
    * retrieve {@link AnalysisOptions} default values
    *
    * @param keywords String[] keyword to look up default for
   ...
   /**
    *
    * @param keyword String to add to global defaults
    * @return Object default value to add to global defaults - be sure to clone
    *    before using!!
    */
   public static Object getGlobalDefaultValue(String keyword)
   {
      AnalysisOption defaultValue = (AnalysisOption) globalDefaults.get(
                                          keyword);
    ...
    *
    * @param keywords array of {@link AnalysisOptions} keywords
    * @param values default values associated with the
    * {@link AnalysisOptions} keywords
    *
    * @return keywords.length
    * @throws Exception if keyword is not available for class
    ********************************************************/
   public int addDefaultValues(String[] keywords, Object[] values)
                        throws Exception
   {
    ...
    *
    * @param keyword String to add to global defaults
    * @param defaultValue Object default value to add to global defaults
    * @return globalDefaults
    */
   public static Object addGlobalDefaultValue(String keyword, 
      Object defaultValue)
   {
   ...
   public Object clone()
   {
      try
      {
         ...
         clone.allKeywords = (allKeywords == null)
                             ? null
                             : (String[]) allKeywords.clone();
         clone.defValues = (defValues == null)
                           ? null
                           : (HashMap) defValues.clone();
   ...
   public boolean equals(Object o)
   {
      ...
      else
      {
         ...
         rtrn = Util.equals(allKeywords, other.allKeywords)
                && Util.equals(defValues, other.defValues);
      }
