...
public class BarPlot extends Plot implements Serializable, Cloneable, AnalysisOptionConstantsIfc {
	...
	{
		/*
		 * String name = "Bar Plot Options"; Class valueType = BarType.class; String toolTipText = null; Class
		 * valueEditorType = BarTypeEditor.class; OptionInfo optionInfo = new OptionInfo(name, valueType, toolTipText,
		 * valueEditorType); OptionInfo.addKeywordAndInfo(BAR_TYPE, optionInfo);
		 */
	}
