 ...
 * </pre>
 *
 * <p><A HREF="doc-files/ExampleHistogramPlot01.html">
 * <B>View an example</B></A>
 *
 * @author Tommy E. Cathey
 * @version $Id: HistogramType.java,v 1.2 2005/09/19 14:50:10 rhavaldar Exp $
 *
 **/
              ...
              LineTypeConstantsIfc
{
   ...
   /**
    * constant used as input to
    * {@link HistogramType#setClosure(boolean)}
    */
   ...
   /**
    * Break Algorithm
    * <br>Use as argument in {@link HistogramType#setBreaks(Object)}
    */
   ...
   /**
    * closure
    * if TRUE, the histograms cells are right-closed intervals (default)
    * if FALSE, the histograms cells are left-closed intervals
    */
   ...
   /**
    * includeLowest
    * if TRUE, an `x[i]' equal to the `breaks' value will be
    * included in the first (or last, for closure = HistogramType.LEFT) bar.
    * This will be ignored unless breaks is a vector.
    */
    ...
    * <p><A HREF="doc-files/ExampleHistogramPlot06.html">
    * <B>View an example</B></A>
    * <br><A HREF="doc-files/ExampleHistogramPlot07.html">
    * <B>View an example</B></A>
    *
    * @param arg color of bar border color
    ********************************************************/
    ...
    * <ol>
    * <li>{@link HistogramType#STURGES}
    * <br>Sturges' formula implicitly basing bin sizes on the range of the data.
    * <li>{@link HistogramType#SCOTT}
    * <br>normal distribution based on the estimate of the standard error.
    * <li>{@link HistogramType#FD}
    * <br>uses the Freedman-Diaconis choice based on the inter-quartile range.
    * </ol>
    * </ul>
    * </ul>
    * <ul>
    *
    * @param arg breaks points of histogram
    ********************************************************/
   ...
   /**
    * set closure
    * if TRUE, the histograms cells are right-closed intervals
    * if FALSE, the histograms cells are left-closed intervals
    *
    * @param arg closure flag
    ********************************************************/
   ...
   /**
    * set color of bars
    * <p><A HREF="doc-files/ExampleHistogramPlot04.html">
    * <B>View an example</B></A>
    * <br><A HREF="doc-files/ExampleHistogramPlot05.html">
    * <B>View an example</B></A>
    *
    * @param arg color of bars
    ********************************************************/
    ...
    * <li>false - plot relative frequencies or probabilities
    * </ul>
    * <p><A HREF="doc-files/ExampleHistogramPlot02.html">
    * <B>View an example</B></A>
    * <br><A HREF="doc-files/ExampleHistogramPlot03.html">
    * <B>View an example</B></A>
    *
    * @param arg plot type flag
    ********************************************************/
   ...
   /**
    * set includeLowest flag
    * if TRUE, an `x[i]' equal to the `breaks' value will be
    * included in the first (or last, for closure = HistogramType.LEFT) bar.
    * This will be ignored unless breaks is a vector.
    *
    * @param arg includeLowest flag
    ********************************************************/
   ...
   /**
    * set labels on flag
    * <p><A HREF="doc-files/ExampleHistogramPlot15.html">
    * <B>View an example</B></A>
    * <br><A HREF="doc-files/ExampleHistogramPlot16.html">
    * <B>View an example</B></A>
    *
    * @param arg labels on flag
    ********************************************************/
    ...
    * <p><A HREF="doc-files/ExampleHistogramPlot12.html">
    * <B>View an example</B></A>
    * <br><A HREF="doc-files/ExampleHistogramPlot13.html">
    * <B>View an example</B></A>
    *
    * @param arg linetype of bar borders
    ********************************************************/
    ...
    * <p><A HREF="doc-files/ExampleHistogramPlot08.html">
    * <B>View an example</B></A>
    * <br><A HREF="doc-files/ExampleHistogramPlot09.html">
    * <B>View an example</B></A>
    *
    * @param arg shading angle
    ********************************************************/
    ...
    * <p><A HREF="doc-files/ExampleHistogramPlot10.html">
    * <B>View an example</B></A>
    * <br><A HREF="doc-files/ExampleHistogramPlot11.html">
    * <B>View an example</B></A>
    *
    * @param arg shading density
    ********************************************************/
    ...
    * <p><A HREF="doc-files/ExampleHistogramPlot14.html">
    * <B>View an example</B></A>
    *
   ...
   public boolean equals(Object o)
   {
      ...
      else
      {
         ...
         rtrn = (frequency == other.frequency)
                ...
                && ((borderColor == null)
                    ? (other.borderColor == null)
                    : (borderColor.equals(other.borderColor)))
                && ((shadingAngle == null)
                    ? (other.shadingAngle == null)
                    : (shadingAngle.equals(other.shadingAngle)))
                && ((shadingDensity == null)
                    ? (other.shadingDensity == null)
                    : (shadingDensity.equals(other.shadingDensity)))
                && ((linetype == null)
                    ? (other.linetype == null)
                    : (linetype.equals(other.linetype)))
                && ((xRange == null)
                    ? (other.xRange == null)
                    : (xRange[0] == other.xRange[0])
                      && (xRange[1] == other.xRange[1]))
