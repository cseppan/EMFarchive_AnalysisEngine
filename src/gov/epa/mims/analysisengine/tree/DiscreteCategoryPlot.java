...
/**
 *
 * DiscreteCategoryPlot is Leaf Node which signals the generation of a
 ...
 * </pre>
 *
 * <br><A HREF="doc-files/ExampleDiscreteCategory01.html">
 * <B>View Example</B></A>
 * <br><A HREF="doc-files/ExampleDiscreteCategory02.html">
 * <B>View Example</B></A>
 * <br><A HREF="doc-files/ExampleDiscreteCategory03.html">
 * <B>View Example</B></A>
 * <br><A HREF="doc-files/ExampleDiscreteCategory04.html">
 * <B>View Example</B></A>
 * <br><A HREF="doc-files/ExampleDiscreteCategory05.html">
 * <B>View Example</B></A>
 * <br><A HREF="doc-files/ExampleDiscreteCategory06.html">
 * <B>View Example</B></A>
 *
              ...
              AnalysisOptionConstantsIfc
{
    ...
    * {@link DiscreteCategoryPlot#setDataSetKeys(Object[])}
    */
   ...
   ****************************************************************************/
   ...
   public void createDataSetKeys(DataSets [] dataSets)
                         throws Exception
   {
  ...
  /**
    ...
    */
   public void createDataSetKeys(ArrayList dataSetKeys)
                          throws Exception
   {
   ...
   private static void initPlotInfo()
   {
      ...
      dataSetInfos[0] = new DataSetInfo("Y values", LabeledDataSetIfc.class, 1,
                                        -1);
      ...
      //
      plotInfo = new PlotInfo(AnalysisEngineConstants.DISCRETE_CATEGORY_PLOT,
                              DiscreteCategoryPlot.class, allKeywords,
                              dataSetInfos);
   }
}