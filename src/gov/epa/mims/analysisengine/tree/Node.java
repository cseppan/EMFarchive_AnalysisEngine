...
/**
 * abstract class Node for the construction of composite
 * plot description trees
 *
 * @author Tommy E. Cathey
 * @version $Id: Node.java,v 1.1 2005/09/19 14:14:13 rhavaldar Exp $
 *
 ******************************************************/
              ...
              VisitableIfc
{
    ...
    *
    * @param i index into the list of children for this node
    *
    ...
    * get an option
    *
    * @param searchKey String which serves as look up searchKey
    * @return the object corresponding to given searchKey
    *  null if searchKey is not in OptionsHash
    * @pre searchKey != null
    ******************************************************/
    ...
    * @throws java.lang.CloneNotSupportedException if not clonable
    ******************************************************/
   public Object clone()
    ...
    *
    * @param c the Class of ancestor to find
    ...
    *
    * @param parent Node which serves as parent to this Node
    *
    ******************************************************/
