 ...
 * @version $Id: DataSetIfc.java,v 1.2 2005/09/19 14:50:10 rhavaldar Exp $
 *
 **************************************************/
public interface DataSetIfc
   extends Serializable
{
   /**
    * The content description is the default value for what would appear
    * on the Y axis, followed by the units.  e.g. "Average exposure"
