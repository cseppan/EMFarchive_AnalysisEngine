 ...
 * @version $Id: AllTests.java,v 1.1 2005/09/19 14:16:05 rhavaldar Exp $
 *
 */
...
//      suite.addTest(gov.epa.mims.analysisengine.tree.test.AllTests.suite());
//      suite.addTest(
//            gov.epa.mims.analysisengine.rcommunicator.test.AllTests.suite());
